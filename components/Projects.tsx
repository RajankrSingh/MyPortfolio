...
const projects: Project[] = [
  ...
  {
    name: 'PayRelax — India Compliance Guide',
    description:
      'Educational resource on Indian labour compliance — PF, ESI, payroll, and labour laws in plain language for employers, HR teams, and employees.',
    longDescription:
      'Built PayRelax (India Compliance Guide) as a structured content site covering labour laws, provident fund, ESI, and payroll compliance. Includes topic hubs, featured guides, PF vs ESI comparisons, blog articles, and clear disclaimers pointing readers to official EPFO and ESIC portals.',
    techStack: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS'],
    liveLink: 'https://www.payrelax.in/',
    category: 'frontend',
    status: 'completed',
    highlights: ['13+ compliance guides', 'PF, ESI & payroll topics', 'Blog & FAQ sections'],
  },
  {
    name: 'VivahKnot — Matrimonial Platform',
    description:
      'Indian matrimonial platform where families discover verified life partners — profile search, match filters, success stories, and premium membership.',
    longDescription:
      'Built VivahKnot as a modern matrimonial website with profile registration, advanced search (age, religion, community, location), verified profiles, privacy controls, success stories, premium plans, and a marriage biodata maker — focused on trust, family-friendly UX, and conversion.',
    techStack: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Supabase'],
    liveLink: 'https://www.vivahknot.com/',
    githubLink: 'https://github.com/RajankrSingh/vivahknot',
    category: 'fullstack',
    status: 'completed',
    highlights: ['Verified profile search', 'Privacy-first matchmaking', 'Success stories & premium tier'],
  },
  {
